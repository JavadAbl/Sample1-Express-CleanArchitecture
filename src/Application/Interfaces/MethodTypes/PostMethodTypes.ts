import { IPostCreateRequest, IPostLikeRequest, IPostUpdateRequest } from "../Request/PostRequests.js";
...
export type IPostLikeActionService = IPostLikeRequest & { userId: number };
